function navBold() {
    document.getElementById("navigation-calendar-button").style.fontWeight = "bold";
}
navBold();
...
function calendarChoiceDay(column) {
    ...
    if (document.getElementsByClassName("choiceDay")[0]) {
        ...
        if (document.getElementById("calMonth").innerText == autoLeftPad((nowDate.getMonth() + 1), 2) && document.getElementsByClassName("choiceDay")[0].innerText == autoLeftPad(toDay.getDate(), 2)) {
            ...
            document.getElementsByClassName("choiceDay")[0].style.fontWeight = "unset";
        }
    ...
    // @param 선택일 체크 표시
    column.style.backgroundColor = "#ABFFB3";
