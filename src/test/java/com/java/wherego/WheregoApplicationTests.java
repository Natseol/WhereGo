...
class WheregoApplicationTests {
	...
	void test() throws IOException  {
		...
		for (JsonNode jsonNode : node) {
			System.out.println(jsonNode.path("CODENAME").asText());
			System.out.println(jsonNode.path("GUNAME").asText());
			System.out.println(jsonNode.path("TITLE").asText());
			System.out.println(jsonNode.path("DATE").asText());
			System.out.println(jsonNode.path("PLACE").asText());
			
			Event temp = new Event(jsonNode.path("CODENAME").asText(), jsonNode.path("GUNAME").asText(),
					jsonNode.path("TITLE").asText(), jsonNode.path("DATE").asText(), jsonNode.path("PLACE").asText());
